...
description: "Did you know that you could validate your CircleCI config before pushing up your changes? Neither did I. I used to write my config, wait for CI to fail and then make the appropriate changes. I got tired of doing that this morning, so decided to googl..."
tags:
---
